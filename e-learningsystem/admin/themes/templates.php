                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo web_root; ?>admin/modules/announcement/index.php"><i class="menu-icon icon-bullhorn"></i>Announcement</a>
                                </li> 
                                <li><a href="<?php echo web_root; ?>admin/modules/review/index.php"><i class="menu-icon icon-bullhorn"></i>Review</a>
                                </li> 
                            </ul>
                            <!--/.widget-nav-->
