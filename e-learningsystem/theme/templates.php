        ...
        <div class="navbar-inner">
          <div class="container">
            ...
            <div class="navigation">
              <nav>
                <ul class="nav topnav" id="sidemenu">
                  <li >
                ...
                <li>
                    <a href="<?php echo web_root; ?>index.php?q=announcement"><i class="icon-list-alt"></i> Announcement</a>
                  </li>
                  <li>
                    <a href="<?php echo web_root; ?>index.php?q=review"><i class="icon-star"></i> Review</a>
                  </li>
